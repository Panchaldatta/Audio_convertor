  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ marginBottom: "10px" }}>PDF to Audiobook Converter</h1>
        ...
        {isProcessing && (
          <p style={{ marginTop: "20px", color: "#6c757d" }}>Generating audiobook... Please wait.</p>
        )}

        {error && <p style={{ color: "#dc3545", marginTop: "20px" }}>{error}</p>}
        ...
        {audioPath && (
          <div style={{ marginTop: "20px" }}>
            ...
            <div style={{ marginTop: "20px" }}>
              <p style={{ fontWeight: "bold", color: darkMode ? "#d1d1d1" : "#6c757d" }}>
                Share on:
              </p>
              <button
